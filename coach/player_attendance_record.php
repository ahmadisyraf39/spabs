...
<head>
    ...
    <title>SPABS: Player's Attendance Record</title>
        ...
        <div class="main">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb ms-5 mt-2">
                    <li class="breadcrumb-item"><a href="attendance_record.php">Attendance Record</a></li>
            ...
            <div class="container p-5">
                ...
                <div class="card mb-5" style="height: 150px;">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-center mb-4"> <strong>Attendance Statistics</strong> </h4>
