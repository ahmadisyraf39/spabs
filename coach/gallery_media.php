...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <header>
                <span class="ms-2">Gallery -
                    <?php echo $nama_aktiviti . ' (' . date('d/m/Y', strtotime($tarikh_aktiviti)) . ')' ?></span>
                                ...
                                if ($fileType === 'image') {
                                    ...
                                    <div class="gallery-item-container">
                                        ...
                                        <form action="media_crud.php" method="GET" style="display:inline;">
                                            <input type="hidden" name="delete" value="<?php echo $readrow['mediaID']; ?>">
                                            <input type="hidden" name="albumID" value="<?php echo $readrow['albumID']; ?>">
                                            <button type="submit"
                                                onclick="return confirm('Are you sure you want to delete this media?');"
                                                class="btn btn-danger btn-xs mt-3">Delete</button>
                                        </form>
                                    </div>
                                    <?php
