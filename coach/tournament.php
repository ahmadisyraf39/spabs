...
// Fetch unanvalaible player with 'Unnotified' status
try {
...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            <header>
                <span class="ms-2">Tournament List - <?php echo $category ?></span>
...
");
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-3 d-flex flex-column justify-content-center ">
                                        <div class="mt-2 text-center">
                                            ...
                                            <br>
                                            <!-- Details Button -->
                                            <a href="player_selection.php?aid=<?php echo $readrow['aktivitiID']; ?>"
                                                class="btn btn-outline-primary btn-xs mb-2" role="button">Player Selection</a>
                                            <br>
                ...
                try {
                    ...
                    $stmt = $conn->prepare("SELECT *, DATE_FORMAT(tarikh_aktiviti, '%e') AS day, CASE DATE_FORMAT(tarikh_aktiviti, '%m')
                            ...
                            WHEN '12' THEN 'Dec'
                            END AS month 
                            FROM tbl_spabs_aktiviti WHERE kategori = :category
                            AND jenis_aktiviti = 'Tournament'
                            AND tarikh_aktiviti < :currentDate
                            ORDER BY tarikh_aktiviti ASC, masa_mula ASC;
