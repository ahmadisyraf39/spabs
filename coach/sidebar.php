...
<body>
    ...
    <aside id="sidebar" class="expand">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a href="team_profile.php" class="sidebar-link <?php if ($currentPage == 'team_profile.php')
                    echo 'active'; ?>">
            ...
            <li class="sidebar-item">
                <a href="attendance_record.php" class="sidebar-link <?php if ($currentPage == 'record_attendance.php')
                    echo 'active'; ?>">
