...
<head>
    ...
    <title>SPABS: Module Progress</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            <header>
                <span class="ms-2">Module Progress - <?php echo $row2['jenis_kemahiran']; ?></span>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb ms-5 mt-2">
                    ...
                    <li class="breadcrumb-item"><a href="skill_progress.php?pid=<?php echo $pid ?>">Skill
                            Progress</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Module Progress</li>
                </ol>
            </nav>
            <div class="container p-5">
                ...
                <?php if ($module_count > 0) { ?>
                            ...
                            <?php foreach ($result as $readrow2) { ?>
                                <div class="col-md-3 mb-5 ">
                                    ...
                                    <?php } elseif ($readrow2['status_capai'] == '50') { ?>
                                        ...
                                        <div><span class="circle bg-primary"> </span><?php echo $readrow2['nama_modul'] ?></div>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div><span class="circle bg-secondary"> </span><?php echo $readrow2['nama_modul'] ?>
                                        </div>
                                    <?php } ?>
                    ...
                    <div class="form-container p-5">
                        ...
                        <?php foreach ($result as $readrow2) {
                            ...
                            $status_capai = isset($readrow2['status_capai']) && $readrow2['status_capai'] !== '' ? $readrow2['status_capai'] . '%' : '0%';
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3 d-flex align-items-center justify-content-center">
                                    <div class="form-group">
                                        <button data-href="module_details.php?mid=<?php echo $readrow2['modulID']; ?>"
                ...
                <?php } else { ?>
                    ...
                    <div class="form-container d-flex justify-content-center align-items-center">No Module Available</div>
